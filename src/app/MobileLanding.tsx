  ...
  return (
    <main className="min-h-screen bg-[#faf8f5] text-[#1e2939]">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-b from-[#ff8c42] to-[#ff6b1a] text-sm font-semibold text-white">
                      {review.initial}
                    </div>
      ...
      <section className="py-12">
        <div className="mx-auto w-full max-w-[420px] px-4">
          <div className="flex items-center gap-3">
            ...
            <span className="rounded-full bg-gradient-to-r from-[#ff6900] to-[#f54900] px-5 py-2 text-sm font-semibold text-white">
              이런 분께 추천해요.
            </span>
            <div className="h-px flex-1 bg-[#ffe1c2]" />
          </div>
      ...
      <section className="py-12">
        <div className="mx-auto w-full max-w-[420px] px-4">
          <div className="flex flex-col items-center gap-2 text-center">
            <p className="text-2xl font-semibold text-[#2d2d2d]">결쌤 상담소 신년운세 해석본의 강점</p>
          ...
          <div className="mt-6 grid gap-4">
            {benefits.map((benefit) => (
              ...
              >
                ...
                <div>
                  <p className="text-base font-semibold text-[#1e2939]">{benefit.title}</p>
                  <p className="mt-2 text-sm leading-6 text-[#666]">{benefit.description}</p>
                </div>
              </div>
            ))}
          </div>
            ...
            <div className="rounded-[16px] border border-[#ffd6a7] bg-white p-5 shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)]">
              ...
              <div className="mt-4 space-y-3">
                <details className="group rounded-xl bg-[#faf8f5] p-4 text-sm text-[#666] [&>summary::-webkit-details-marker]:hidden">
                  <summary className="flex cursor-pointer list-none items-center justify-between font-semibold text-[#1e2939]">
                    오행 용신에 맞는 실천 방법 (예시)
                    <span className="text-[#ff8c42] transition group-open:rotate-45">+</span>
                  </summary>
                  <div className="mt-3 space-y-3">
                    <div>
                      <p className="font-semibold text-[#1e2939]">목 기운이 용신이거나 희신인 경우</p>
                      <ul className="mt-2 space-y-1">
                        <li>• 운동: 등산, 산림욕, 클라이밍, 요가</li>
                        <li>• 시간 활용: 아침(새벽)에 일찍 일어나기</li>
                        <li>• 좋은 지역: 숲, 강원도</li>
                        <li>• 그 외: 식물 가꾸기</li>
                      </ul>
                    </div>
                    <div>
                      <p className="font-semibold text-[#1e2939]">화 기운이 용신이거나 희신인 경우</p>
                      <ul className="mt-2 space-y-1">
                        <li>• 운동: 조깅</li>
                        <li>• 시간 활용: 낮 시간에 밖에 나가 활동하기</li>
                        <li>• 좋은 지역: 햇볕이 잘 드는 지역 (대구광역시·제주도·일본)</li>
                        <li>• 그 외: 인터넷 서핑, 밝은 조명의 실내, 모닥불</li>
                      </ul>
                    </div>
                  </div>
                </details>
                <details className="group rounded-xl bg-[#faf8f5] p-4 text-sm text-[#666] [&>summary::-webkit-details-marker]:hidden">
                  ...
                  <ul className="mt-3 space-y-2">
                    <li>• 비겁이 용신인 경우: 형제자매, 동료, 동기</li>
                    <li>• 식상이 용신인 경우: 부하 직원, 아랫사람</li>
                    <li>• 재성이 용신인 경우: 아버지, 아내</li>
                  </ul>
                </details>
                <details className="group rounded-xl bg-[#faf8f5] p-4 text-sm text-[#666] [&>summary::-webkit-details-marker]:hidden">
                  <summary className="flex cursor-pointer list-none items-center justify-between font-semibold text-[#1e2939]">
                  ...
                  <ul className="mt-3 space-y-2">
                    <li>• 비겁이 용신인 경우: 무슨 일이든 사람들과 함께하기</li>
                    <li>• 식상이 용신인 경우: 친한 친구들과의 식사, 소모임 참석</li>
                    <li>• 재성이 용신인 경우: 회식 참여, 동호회 활동</li>
                  </ul>
                </details>
              </div>
            </div>
      ...
      <section className="bg-gradient-to-b from-white to-[#fff7ed] py-12">
        <div className="mx-auto w-full max-w-[420px] px-4">
          <div className="flex flex-col gap-4 text-center">
            <p className="text-2xl font-semibold text-[#1e2939]">진행 방식은 이렇게 간단해요</p>
          ...
          <div className="mt-6 grid gap-4">
            {steps.map((step) => (
              ...
              >
                ...
                <div>
                  <p className="text-base font-semibold text-[#1e2939]">{step.title}</p>
      ...
      <section className="py-12">
        <div className="mx-auto w-full max-w-[420px] px-4">
          <div className="flex flex-col items-center gap-2 text-center">
            <p className="text-2xl font-semibold text-[#2d2d2d]">주의사항</p>
        ...
        <div className="mx-auto w-full max-w-[420px] px-4">
          <div className="rounded-[14px] border-2 border-[#ffd6a7] bg-white p-6 shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]">
            ...
            <div className="mt-4 grid gap-6">
              <div>
                <p className="text-base font-semibold text-[#1e2939]">ChatGPT로 올해 운세를 확인해도 되나요?</p>
          ...
          <div className="mt-8 rounded-[14px] bg-white p-6 shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm font-semibold text-[#1e2939]">ChatGPT 사주 계산 오차 사례</p>
            </div>
          ...
          <div className="grid gap-8 rounded-[16px] bg-white p-6 shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]">
            ...
            <div>
              ...
              <p className="mt-4 text-sm font-semibold text-[#1e2939]">
                복잡한 삶의 문제, 한 가지 방법으로는 부족할 때가 있어요.
              </p>
              <p className="mt-2 text-sm text-[#666]">
                동서양의 강력한 도구를 융합해 지금 당신에게 가장 효율적인 해답을 찾습니다.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="pb-16 pt-10">
        <div className="mx-auto flex w-full max-w-[420px] flex-col gap-4 px-4">
          <div className="grid gap-4">
            <button className="rounded-full bg-gradient-to-b from-[#ff8c42] to-[#ff6b1a] px-5 py-4 text-base font-semibold text-white shadow-[0px_12px_20px_-10px_rgba(255,107,26,0.7)]">
              상담문의 (네이버 톡톡)
            </button>
            <button className="rounded-full bg-gradient-to-b from-[#ff8c42] to-[#ff6b1a] px-5 py-4 text-base font-semibold text-white shadow-[0px_12px_20px_-10px_rgba(255,107,26,0.7)]">
              상담문의 (카카오톡)
