...
const steps = [
  {
    number: "1",
    title: "신청하기",
    description: "2026 병오년 전통 사주 핵심 리포트 신청",
  },
  {
    number: "2",
    title: "결제",
    description: "리포트 신청 후 결제가 진행됩니다.",
  },
  {
    number: "4",
    title: "사전 질문 전달",
    description:
      "사전 질문: 생년월일, 태어난 시간(가능 시), 신년운 분야(재물/건강/직장/사업/연애), 추가 질문",
  },
  {
    number: "5",
  ...
  {
    number: "6",
    title: "(필요 시) 리포트 해석이 어려우시면 ‘리포트 해석(리딩) 상담’ 신청 가능해요. (리포트 구매자 1만원 할인)",
        ...
        <div className="mx-auto w-full max-w-[420px] px-4">
          ...
          <div className="mt-4 rounded-[14px] bg-white p-4 shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] sm:mt-6 sm:p-6">
            ...
            <p className="mt-3 text-sm leading-6 text-[#666] sm:mt-4">
              ...
              정확한 사주(명식) 조회가 가능한{" "}
              <span className="text-base font-semibold text-[#ff7d30]">
